...
const CardzModal = ({ show, handleClose, avatarImage, username, userId, images, status, postId, postContent, postTimeStamp }) => {
        ...
        >
            ...
            >
                <Container>
                    ...
                    <Row>
                        <Col lg={5} className='d-flex align-items-center px-2'>
                    ...
                    <Row>
                        <UpCommentShareBtn userAvatarImage={avatarImage} />
                    </Row>
                </Container>
            </Modal.Body>
